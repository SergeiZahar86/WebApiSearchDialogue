...
{
    /// <summary>
    /// Сущность предназначенная для хранения информации о том, какие
    /// пользователи взаимодействуют в рамках одного диалога.
    /// </summary>
    public class RGDialogsClients
    {
        ...
        /// <summary>
        /// Функция Init позволяет получить набор сущностей
        /// <see cref="RGDialogsClients"/>,
        /// с которыми можно производить операции.
        /// </summary>
